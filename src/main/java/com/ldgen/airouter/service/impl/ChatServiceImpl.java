...
import com.ldgen.airouter.model.dto.chat.ChatMessage;
...
import com.ldgen.airouter.service.RequestLogService;
...
public class ChatServiceImpl implements ChatService {
    ...
    private Prompt buildPrompt(ChatRequest chatRequest) {
        List<AbstractMessage> messages = chatRequest.getMessages().stream()
        ...
        return new Prompt((Message) messages, optionsBuilder.build());
    }
